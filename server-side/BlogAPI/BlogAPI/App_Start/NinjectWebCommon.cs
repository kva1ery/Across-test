using BlogApiEF;
using BlogApiEF.Repositories;
using BlogDomain.Repositories;
using BlogDomain.Services;

[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(BlogAPI.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(BlogAPI.App_Start.NinjectWebCommon), "Stop")]
